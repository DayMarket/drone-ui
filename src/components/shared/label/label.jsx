...
import Box from 'svg/scm/box.svg';
import Branch from 'svg/scm/branch.svg';
import Commit from 'svg/scm/commit.svg';
import Number from 'svg/scm/number.svg';
import PullRequest from 'svg/scm/pr.svg';
import Tag from 'svg/scm/tag.svg';
